...
Students often utilize online calendars to organize their schedules, but the current options available are either too cluttered, convoluted, or do not implement some features students would appreciate having. For example, some currently use Google Calendar to store their class schedule and due dates. However, the user interface is not designed to effectively remind students of upcoming due dates and is intended purely for use as a calendar to store scheduled events. This makes it difficult to view the information that you need in a timely manner, which is essential for students. How can we design a task-oriented calendar to address the issues facing students using the current models of digital calendar organization?
